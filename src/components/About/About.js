...
const About = () => {
  ...
  return (
    <Container className="p-4">
      ...
      <AboutSection svgStyle="chessSVG" year="1995 - 2005" style={style}>
        I’ve always loved solving problems and thinking strategically. Growing up, I played chess for England.
      </AboutSection>
      <AboutSection svgStyle="mathSVG" rowStyle="flex-row-reverse" year="2006 - 2011" style={style}>
      ...
      <AboutSection svgStyle="pokerSVG" year="2011 - 2013" style={style}>
      ...
      <AboutSection svgStyle="accountingSVG" rowStyle="flex-row-reverse" year="2013 - 2021" style={style}>
      ...
      <AboutSection svgStyle="codingSVG"  year="2013 - 2021" style={style}>
        If you take a peek at my Github profile, you'll see that I signed up in 2013. Back in those days I was still learning HTML &amp; CSS, whilst following Ruby on Rails zombie app tutorials on Code Academy. I dabbled around, coding on and off over the years. It's now 2021 and I've decided to take coding more seriously. I committed to one Github commit every single day for a year. 
      </AboutSection>
      <AboutSection svgStyle="futureSVG" rowStyle="flex-row-reverse" year="Future Me" style={style}>
